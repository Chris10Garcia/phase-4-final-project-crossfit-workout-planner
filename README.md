# Phase 5 Project: Flatiron CrossFit
...
Welcome to my phase 5 final project: The Flatiron Crossfit Workout and Class viewer! This is meant to be a light version of the Wodify app, a gym and studio management software platform.
...
- log in, giving the logged in user the ability to edit, create, or delete records
- use socket.io to communicate between the frontend and backend

Phase 5 requirements: 
- this project utilizes authentication and pass the logged in user to various components via React useContext.
- this project utilizes WebSocket (socket.io) as the new technology requirement. I used socket.io as the communication between the server and client
...
1. Database Object Serialization
...
- create socket.io events to transmit data between the frontend and backend
- This application follows the project requirements: 
    - All tables have CREATE, READ actions plus EDIT
...
- Instantiate marshmallow serializer, and CORS objects
- Initialize the socket.io app
